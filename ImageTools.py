...
##                self.new_image.putpixel((num_x, num_y), color)
    ...
    def overlay(self, base_image=None, base_image_name=None, added_image=None, added_image_name=None, input_folder=None, output_folder=None, output_file_name='output', auto_resize=False, save_image=True):
        ...
        if save_image:
            overlayed_image.save(output_folder + output_file_name + '.png', 'PNG')
    ...
    def overlayBatch(self, added_image_name, input_folder=None, output_folder=None,
        ...
        for base_image_name in os.listdir(input_folder):
            ...
            overlayed_image = self.overlay(base_image_name, added_image_name, input_folder=input_folder, output_file_name=output_file_name, auto_resize=auto_resize)
...
### Portrait
    ...
    IT.appendBatch(input_folder='crop_outputs', base_image_name='portrait_bumper.png', number_outputs=True, include_original_name=False, clear_output_folder=True)
...
### Videos
    #IT.overlayVideo(base_image_name='FAB Bumper 4 960x.png', video_name='FAB Factory Drone Video - Studio 3.mp4', input_folder='inputs', output_folder='outputs')
